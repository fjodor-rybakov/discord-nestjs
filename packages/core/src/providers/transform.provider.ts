...
// import { DiscordArgumentMetadata } from '../../dist/decorators/pipe/discord-argument-metadata';
//
// @Injectable()
...
//     const paramData =
//       this.transformParamResolver.getTransformParamByTarget(metatype);
...
//       }
//     }
//     const newClass = plainToClass(metatype, newObj, options);
//     await Promise.all(
